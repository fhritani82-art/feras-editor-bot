...
# Bot Token and OpenAI API Key
BOT_TOKEN = "8701233956:AAHdgRbVqf46db-nsh2lDXWA1LY7ohiVNgQ"
# OPENAI_API_KEY is expected to be set as an environment variable
client = OpenAI()
...
def main() -> None:
    ...
    # On non command i.e. message - correct the text
